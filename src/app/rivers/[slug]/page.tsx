      ...
      <section className={`river-hero ${river.gradient}`}>
        <div className="container">
          ...
          <div className="hero-stats">
            {content.totalLength > 0 && <div className="hero-stat"><div className="num">{content.totalLength}</div><div className="lbl">km total length</div></div>}
          ...
          <div className="route-grid">
            <div>
              ...
              {content.highlights.length > 0 && (
                <div style={{ marginTop: 24 }}>
                  <h3 style={{ fontSize: 16, fontWeight: 700, marginBottom: 12 }}>Highlights</h3>
            ...
            <div>
              <div className="booking-card">
                <h3>Book a Trip</h3>
                <p>{routes.length} routes available on the {river.name}.</p>
                <Link href="/booking" className="btn btn-primary" style={{ display: 'block', textAlign: 'center', width: '100%' }}>
                  Book Now
                </Link>
                <div style={{ textAlign: 'center', marginTop: 12 }}>
                  <Link href="/contact" style={{ fontSize: 13, color: 'var(--primary)' }}>Need help choosing a route? →</Link>
                </div>
              </div>
            </div>
          </div>
