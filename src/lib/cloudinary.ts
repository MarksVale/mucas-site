...
export function cldHero(type: 'rivers', slug: string): string {
  return `${BASE}/${FALLBACK}/c_fill,g_auto:subject,w_1400,h_600,q_auto,f_auto/mucas/${type}/${slug}/gallery-1`
}

/** Gallery thumbnail (800×560, smart-cropped) */
export function cldGallery(slug: string, n: number): string {
  return `${BASE}/${FALLBACK}/c_fill,g_auto:subject,w_800,h_560,q_auto,f_auto/mucas/rivers/${slug}/gallery-${n}`
}
