...
const DEFAULT_ABOUT_EN: AboutPageContent = {
  ...
  values: [
    { icon: 'globe', title: 'Respect for Nature', description: 'We follow leave-no-trace principles and actively maintain the rivers and camping spots we use. Every trip includes a waste bag.' },
    { icon: 'handshake', title: 'Local Community', description: 'We partner with local farmers, guesthouses, and guides along every river. Your trip supports the rural economy.' },
    { icon: 'shield', title: 'Safety Always', description: 'Every paddler gets a safety briefing, life jacket, and waterproof emergency contact card. We monitor weather and water levels daily.' },
    { icon: 'accessibility', title: 'Accessibility', description: 'We offer adapted boats and assisted launch for paddlers with mobility challenges on selected routes.' },
  ],
  numbersLabel: 'Impact',
...
const DEFAULT_ABOUT_LV: AboutPageContent = {
  ...
  values: [
    { icon: 'globe', title: 'Cieņa pret Dabu', description: 'Mēs ievērojam "atstāj bez pēdām" principus un aktīvi uzturām upes un kempinga vietas, ko izmantojam. Katrs brauciens ietver atkritumu maisu.' },
    { icon: 'handshake', title: 'Vietējā Kopiena', description: 'Mēs sadarbojamies ar vietējiem zemniekiem, viesu namiem un gidiem gar katru upi. Jūsu brauciens atbalsta lauku ekonomiku.' },
    { icon: 'shield', title: 'Drošība Vienmēr', description: 'Katrs airētājs saņem drošības instruktāžu, glābšanas vesti un ūdensizturīgu ārkārtas kontaktkarti. Mēs katru dienu uzraugām laiku un ūdens līmeņus.' },
    { icon: 'accessibility', title: 'Pieejamība', description: 'Mēs piedāvājam pielāgotas laivas un palīdzētu palaišanu airētājiem ar mobilitātes izaicinājumiem izvēlētos maršrutos.' },
  ],
