...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'statRiversLabel',    title: 'Stat: Rivers Label (EN)',     type: 'string' }),
    defineField({ name: 'statRiversLabelLv',  title: 'Stat: Rivers Label (LV)',     type: 'string' }),
    defineField({ name: 'statRoutesLabel',    title: 'Stat: Routes Label (EN)',     type: 'string' }),
    defineField({ name: 'statRoutesLabelLv',  title: 'Stat: Routes Label (LV)',     type: 'string' }),
    defineField({ name: 'statBoatTypesLabel',   title: 'Stat: Boat Types Label (EN)', type: 'string' }),
    defineField({ name: 'statBoatTypesLabelLv', title: 'Stat: Boat Types Label (LV)', type: 'string' }),
    defineField({ name: 'statFromLabel',    title: 'Stat: From/day Label (EN)',   type: 'string' }),
    defineField({ name: 'statFromLabelLv',  title: 'Stat: From/day Label (LV)',   type: 'string' }),
    // RIVERS SECTION
